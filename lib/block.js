...
class Block {
    static calcMerkleRoot(txArr) {
        return native.Block_calc_tx_merkle_root(this.transactions);
    }
    ...
    verifyMerkleRoot() {
        const root = native.Block_calc_tx_merkle_root(this.transactions);
        return root.equals(this.tx_merkle_root);
    }
